...
class TestTwenty:
    ...
    def test_ts020(self):
        ...
        WebDriverWait(self.driver, 6).until(EC.element_to_be_clickable((By.ID, "description"))).send_keys("Test1234")
        WebDriverWait(self.driver, 6).until(EC.element_to_be_clickable((By.XPATH, "//button[@type='submit']"))).click()
