...
class TestEighteen:
    ...
    def test_ts018(self):
        ...
        WebDriverWait(self.driver, 6).until(EC.element_to_be_clickable((By.XPATH, "//input[@name='startTime']"))).clear()
        ...
        self.driver.find_element_by_xpath("//input[@name='stopTime']").send_keys(" 2017-10-30 07:30:00")
        time.sleep(5)